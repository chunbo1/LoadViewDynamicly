...
namespace LoadViewDynamicly
{
    ...
    public class Messenger
    {
        ...
        private class WeakAction
        {
            ...
            //A weak reference object will keep a reference to an object that went out of scope or was set to null, 
            //until it is actually deleted by the garbage collector.But until that happens, we can get the object back!
            #endregion // Fields
        }

...
{
    class ClassPnLViewModel : ReportViewModelBase<ClassPnLReport>
    {
        DataClasses1DataContext dc = new DataClasses1DataContext(Properties.Settings.Default.MDH2ConnectionString);
        private string _semester;
        public LoadViewDynamicly.Report.ClassPnLReport _view { get; set; }

        public ClassPnLViewModel(ClassPnLReport view) : base(view)
        {
            //Semester = "2017 Fall";
            _view = view;
        }
